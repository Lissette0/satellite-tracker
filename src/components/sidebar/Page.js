                        ...
                        return(
                            <div key={item.name}>
                                <div className="inner-content">
                                    <p className= "sat-label">{" "}<b className="name">{item.name}</b>{" "}</p>
                                    <p className= "sat-label"><b> Classification: </b> {item.classification}</p>
                                    <p className= "sat-label"> <b>International designation: </b> {item.international_designation}{" "}</p>
                                    <p className= "sat-label"> <b>Description:</b> {item.description} </p>
                                    ...
                                    <button className="pl-2 pr-2 mr-2 border-2 border-white-600">Show Path</button> */}
                                </div>
                                <hr />
                            </div>
